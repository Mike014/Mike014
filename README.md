...
|---------|-------------|--------------|
| ![Remote Jobs App](https://img.shields.io/badge/RemoteJobs%20App%20Icon?style=for-the-badge&logo=github&logoColor=white) [Remote_Jobs_App](https://remotejobsapp.onrender.com/) | A Flask-based web application to explore companies offering remote jobs. | Flask, Flask-SQLAlchemy, Bootstrap |
